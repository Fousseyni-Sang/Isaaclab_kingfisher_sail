...
class DiscriminatorNetwork(nn.Module):
    def __init__(self, lr, state_dim, context_dim,
                 fc1_dims=256, fc2_dims=256, prediction_dims=1,
                 num_envs=1024, mem_size=1000,
                 name='discriminator', chkpt_dir='/tmp/sac', device='cpu'):
        super().__init__()
        ...
        self.memory = ReplayBuffer(num_envs, mem_size, self.state_dim, device)
        self.batch_size = 256
...
if __name__=="__main__":
    ...
    discriminator1 = DiscriminatorNetwork(lr=0.0001, state_dim=1, context_dim=1, fc1_dims=256, fc2_dims=256, prediction_dims=1, 
                                                   num_envs=num_envs, mem_size=mem_size)
    discriminator2 = DiscriminatorNetwork(lr=0.0001, state_dim=1, context_dim=1, fc1_dims=256, fc2_dims=256, prediction_dims=1, 
                                                num_envs=num_envs)
