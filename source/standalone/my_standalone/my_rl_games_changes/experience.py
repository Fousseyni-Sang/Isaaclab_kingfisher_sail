...
class ExperienceBuffer:
    ...
    def _init_from_env_info(self, env_info):
        ...
        self.tensor_dict['loss_mask'] = self._create_tensor_from_space(val_space, obs_base_shape)
        ...
        self.tensor_dict['feasibility_map'] = torch.zeros((*self.obs_base_shape, 10, 10, 10), device=self.device, dtype=torch.float32)
