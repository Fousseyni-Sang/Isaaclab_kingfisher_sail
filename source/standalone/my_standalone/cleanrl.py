...
parser.add_argument("--task_name", type=str, default="kingfisher_sail_direct", help="directory name for the task")
...
parser.add_argument("--horizon_length", type=int, default=48, help="number of steps to run in each environment per policy rollout")
